...
function Login() {
  ...
  return (
    ...
    flex flex-col items-center justify-start'>
      ...
      bg-[purple] rounded-[10px] p-[15px]' onSubmit={handleSignIn}>
        <h1 className='text-gray-800 text-[30px]
        font-semibold mb-[30px]'>Sign In</h1>
        ...
        <button className='w-[100%] h-[50px] rounded-full bg-[#24b2ff]
         text-white mt-[40px]'disabled={loading}>{loading?"Loading...":"Sign In"}</button>
        <p className='text-center cursor-pointer' onClick={() => navigate('/signup')}>want to create a new account? 
          <span className='text-[#2a9bd8]'> Sign Up</span></p>
      </form>
